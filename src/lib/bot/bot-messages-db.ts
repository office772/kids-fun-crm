...
export const BOT_MESSAGE_REGISTRY: Record<string, BotMessageDef> = {
  ...
  // 23.9: ההורה דוחה להמשך ("אחזור מחר לרשום", "נדבר אחר כך") - לא מתחילים מסלול, מחכים
  defer_reply: {
    label: 'ההורה דוחה להמשך (אחזור מחר / נדבר אחר כך)',
    category: 'כללי',
    vars: [],
    default: `בכיף, מחכה לכם 😊 כשתרצו להמשיך פשוט כתבו לי 💛`,
  },
