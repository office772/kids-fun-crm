...
import {
  ...
  Settings, Zap, Lightbulb, ChevronDown, ExternalLink, MessageCircle, type LucideIcon,
} from 'lucide-react'
...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    intro: 'עריכת מה שהבוט עונה בוואטסאפ — שלוש לשוניות:',
    points: [
      'תכני הודעות — הודעות הבוט (ברכה, אישור רישום...). לערוך, להוסיף, לכבות/להפעיל.',
      'שאלות ותשובות — שהבוט עונה אוטומטית. הוסיפי מילות מפתח לזיהוי ניסוחים שונים.',
      'הגדרות מערכת. מתג תצוגה כרטיסים/טבלה למעלה.',
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      'קיבולת לפי מסגרת — מקסימום נרשמים לכל גן/בי"ס בנפרד (ריק = ללא הגבלה). כשגן מתמלא, נרשמים חדשים עוברים אוטומטית לרשימת המתנה.',
