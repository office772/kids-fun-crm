...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    note: '📝 עריכת הטקסט של הודעות הבוט הקבועות (ברכה, אישורים) עדיין בפיתוח — בינתיים לשינוי ניסוח פנו לעינת.',
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      'תכני הודעות — תצוגת הודעות הבוט הקבועות. עריכת הטקסט תתווסף בקרוב; בינתיים לשינוי ניסוח פנו לעינת.',
