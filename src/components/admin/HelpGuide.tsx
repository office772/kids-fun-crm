...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    points: [
      ...
      'טקסט הודעות הבוט — דשבורד → תוכן הבוט → תכני הודעות. עריכת הטקסט של כל הודעות הבוט הקבועות (רישום, ביטול, תשלומים, קייטנה, איסוף ועוד), מקובצות לפי נושא. המשתנים בסוגריים {…} נעולים — הבוט ממלא אותם.',
    ...
    note: '📝 כל הודעות הבוט הקבועות ניתנות לעריכה. ערכו רק את הטקסט — המשתנים {…} נעולים, ותמיד אפשר "שחזור לברירת מחדל".',
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      'תכני הודעות — ✅ עריכת הטקסט של כל הודעות הבוט הקבועות, מקובצות לפי נושא. ערכו רק את הטקסט; המשתנים {…} נעולים והבוט ממלא אותם. כפתור "שחזור לברירת מחדל" מחזיר הודעה למקור.',
